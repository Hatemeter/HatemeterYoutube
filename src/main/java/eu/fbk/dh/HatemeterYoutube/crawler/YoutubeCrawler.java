package eu.fbk.dh.HatemeterYoutube.crawler;
...
public class YoutubeCrawler {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String language = args[a];

            InputStream input = YoutubeCrawler.class.getClassLoader().getResourceAsStream("config.properties");
            Properties prop = new Properties();
            prop.load(input);
            String commentsFilePath = prop.getProperty("commentsFilePath");

            File listFile = new File(commentsFilePath + File.separator + language + "_list");
            if (!listFile.exists()) {
                throw new FileNotFoundException("List file not found");
            }
            List<String> words = Files.readLines(listFile, Charsets.UTF_8);

            File langFolder = new File(commentsFilePath + File.separator + language);
            langFolder.mkdirs();
            ...
            for (String word : words) {
                ...
                String fileName = commentsFilePath + File.separator + language + File.separator + fName + ".txt";
                ...
                while (nextPage != null) {
                    ...
                    search.setOrder("relevance"); //date rating relevance title videoCount viewCount
